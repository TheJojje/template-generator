<?php
    ...
    $stmt = $pdo->prepare("INSERT INTO forms (form_name, form, access_group_id, comment) VALUES (?, ?, ?, ?)");
    $stmt->execute([$form_name, $form, $access_group_id, $comment]);
	
	// Insert into activities
	$access_group_id = $_SESSION['access_group_id'];
	$activityMessage = "Created the form $form_name.";
	...
	<body>
		...
		<aside id="sidebar" class="sidebar">
			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<!-- Start Form nav -->
				<li class="nav-item">
					<a class="nav-link" data-bs-target="#variables-nav" data-bs-toggle="collapse" href="#">
						<i class="bi bi-menu-button-wide"></i><span>Forms</span><i class="bi bi-chevron-down ms-auto"></i>
					</a>
					<ul id="variables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
						<li>
						...
						<li>
							<a href="add_form.php" class="active">
										...
										<form method="POST" action="">
											<table class="table small table-borderless">
												<tr>
													...
													<td><input type="text" name="form_name" class="form-control" required></td>
												</tr>
												<tr>
													<th>Comment</th>
												...
												<tr>
													<td colspan="2"><textarea name="form" class="form-control" rows="10" required></textarea></td>
												</tr>
												<tr>
