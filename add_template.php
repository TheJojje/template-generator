<?php
    ...
    $stmt = $pdo->prepare("SELECT * FROM forms WHERE access_group_id = :access_group_id");
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    	...
    	$stmt = $pdo->prepare("INSERT INTO templates (template_name, form_id, template_comment, template_content, access_group_id, author) VALUES (:template_name, :form_id, :template_comment, :template_content, :access_group_id, :author)");
    	$stmt->execute([
		...
		$activityMessage = "Created the template $template_name.";
			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<li class="nav-item">
					...
					<ul id="templates-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="add_template.php" class="active">
										...
										<form method="POST">
											<table class="table small table-borderless">
												<tr>
													...
													<td><input type="text" name="template_name" class="form-control" required></td>
												</tr>
												<tr>
													<th>Form</th>
													<td>
														...
														echo '<select name="form_id" class="form-select">';
															foreach ($forms as $form) {
																echo '<option value="' . htmlspecialchars($form['id']) . '">' . htmlspecialchars($form['form_name']) . '</option>';
															}
														echo '</select>';
														?>
													</td>
												...
												<tr>
													<th>Comment</th>
													<td><textarea name="template_comment" class="form-control"></textarea></td>
												</tr>
												<tr>
													<th colspan="2">Configuration</th>
												</tr>
												<tr>
													<td colspan="2"><textarea name="template_content" class="form-control" rows="20" required></textarea></td>
												</tr>
												<tr>
													<td colspan="2"><button type="submit" class="btn btn-outline-success btn-sm">Create</button></td>
												</tr>
											</table>
										</form>
									</div>
