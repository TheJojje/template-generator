<?php
	...
	$sql = "SELECT activities.id, activities.activity_text, activities.user, activities.access_group_id, activities.timestamp, access_groups.access_group_name 
		FROM activities 
		LEFT JOIN access_groups ON activities.access_group_id = access_groups.id 
		ORDER BY activities.timestamp DESC"; // Fetch activities and their related access group name
			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<li class="nav-item">
					...
					<ul id="admin-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="activites_admin.php" class="active">
        				...
        				<?php if ($activities): ?>
            				<?php foreach ($activities as $activity): ?>
                				<tr>
                    				...
                    				<td><?php echo htmlspecialchars($activity['access_group_name']); ?></td>
